...
const ensureActionBindings = (uiDefinition, { thingActions = [], fallbackThingId = null } = {}) => {
  ...
  traverseComponents(uiDefinition, (component) => {
    ...
    const candidateActions = resolvedThingId && actionsByThing.has(resolvedThingId)
      ? actionsByThing.get(resolvedThingId)
      : actions;
    ...
    if (!inferred) {
      console.warn(`[KB] Interactive component '${props.label || type}' is missing an action binding.`);
      return;
    }
